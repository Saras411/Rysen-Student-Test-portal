...
export default class ErrorBoundary extends React.Component {
  ...
  render() {
    if (this.state.hasError) {
      return (
        <div style={{ padding: "40px", color: "red", background: "#f8d7da" }}>
...
<body>${printContent}</body>
  ...
  const indicatorsB = {
    ...
    4: [
      ["Identifying the Odd One Out", "Q12", qLvl(["B1"])],
      ["Pattern Completion (Double Pattern)", "Q13", qLvl(["B2"])],
      ["Syllogism & Logical Conclusion", "Q14", qLvl(["B3"])],
      ["Alphabet–Number Sequence Logic", "Q15", qLvl(["B4"])],
      ["Direction Sense & Spatial Reasoning", "Q16", qLvl(["B5"])],
      ["Logical Contradiction", "Q17", qLvl(["B6"])],
      ["Coding–Decoding / Hard Logical Reasoning", "Q18", qLvl(["B7"])],
    ],
    5: [
  ...
  const indicatorsC = {
    3: [
      ["Number Names & Place Value", "Q7", qLvl(["C1","C2"])],
      ["Number Comparison & Ordering", "Q8", qLvl(["C3","C4"])],
      ["Basic Operations – Word Problems", "Q9", qLvl(["C5"])],
    ],
    4: [
      ["Understanding of Fractions & Decimals", "Q19", qLvl(["C1"])],
      ["Concept of Terminating & Non-terminating Decimals", "Q20", qLvl(["C2"])],
      ["Rational & Irrational Numbers", "Q21", qLvl(["C3"])],
      ["HCF–LCM Relationship", "Q22", qLvl(["C4"])],
      ["Divisibility Rules", "Q23", qLvl(["C5"])],
      ["Comparison of Decimals", "Q24", qLvl(["C6"])],
      ["Remainder Theorem / Logical Reasoning", "Q25", qLvl(["C7"])],
    ],
    5: [
